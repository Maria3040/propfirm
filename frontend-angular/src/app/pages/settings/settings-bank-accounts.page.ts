...
@Component({
  selector: 'app-settings-bank-accounts-page',
  standalone: true,
  template: `
    <div class="settings-page">
      <h1 class="settings-page-title">Bank Accounts</h1>
      <div class="sb-empty">
        ...
        <p>
          You're not currently eligible for wire transfers. Please contact support if you believe this is an error.
        </p>
      </div>
    </div>
  `,
})
export class SettingsBankAccountsPage {}
